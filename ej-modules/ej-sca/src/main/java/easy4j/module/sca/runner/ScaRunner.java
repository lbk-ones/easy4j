...
public class ScaRunner extends StandAbstractEasy4jResolve implements InitializingBean, CommandLineRunner, DisposableBean {
    ...
    public void run(String... args) throws Exception {
        ...
        String group = Easy4j.getRequiredProperty(Easy4j.getEjSysPropertyName(EjSysProperties::getNacosConfigGroup));
...
//                        }
//                        if (!map.isEmpty()) {
//                            CustomPropertyResolver customPropertyResolver = new CustomPropertyResolver(propertySources);
//                            for (Map.Entry<String, Object> stringObjectEntry : map.entrySet()) {
//                                String key = stringObjectEntry.getKey();
//                                Object value = stringObjectEntry.getKey();
//                                customPropertyResolver.updateProperty(AbstractEasy4jEnvironment.FIRST_ENV_NAME, key, value);
//                            }
