 ...
 * @date 2025/8/8
 */
public class PageRes extends EasyMap<String, Object> {
    ...
    public PageRes(long pageNo, long pageSize, List<?> objects) {
        init(this);
        setPageNo(pageNo).
    ...
    public PageRes(List<?> objects) {
        init(this);
        setRecords(objects);
    }


    public static void init(PageRes that) {
        that.put(PAGE_NO, 0);
    ...
    public PageRes setPageNo(long pageNo) {
        put(PAGE_NO, pageNo);
        return this;
    }

    public PageRes setPageSize(long pageSize) {
        put(PAGE_SIZE, pageSize);
        return this;
    }

    public PageRes setRecords(Iterable<?> records) {
        put(RECORDS, records);
        return this;
    }

    public PageRes setTotal(long total) {
        put(TOTAL, total);
        return this;
    }
