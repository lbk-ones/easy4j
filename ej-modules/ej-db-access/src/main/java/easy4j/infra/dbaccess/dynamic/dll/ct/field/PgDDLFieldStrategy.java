...
public class PgDDLFieldStrategy extends AbstractIDDLFieldStrategy {
    ...
    private void parseNotNullDefault(PgSQLFieldType pgSQLFieldType, List<String> objects, DDLFieldInfo ddlFieldInfo, DDLConfig ddlConfig) {
    ...
    private String getCurrentTimeFunc(PgSQLFieldType pgSQLFieldType) {
