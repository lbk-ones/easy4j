    ...
    public static void init(){
        synchronized (InitConfig.class){
            ...
            if(enabled && runtimePort>0 && StrUtil.isNotBlank(url)){
                ...
                SentinelConfig.setConfig(TransportConfig.SERVER_PORT,String.valueOf(runtimePort));
                ...
                SentinelConfig.setConfig(SentinelConfig.APP_NAME_PROP_KEY,Easy4j.getProperty(SysConstant.SPRING_SERVER_NAME));
