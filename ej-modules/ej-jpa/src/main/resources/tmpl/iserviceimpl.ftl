...
public class ${interfaceImplName} extends BaseService
<${domainName}Dao,String,${domainName}> implements ${interfaceName} {
public static Class<${domainName}> clazz = ${domainName}.class;

@Override
public Map
<String,Object> get${domainName}List(${domainName}Dto ${firstLowDomainName}Dto) {
isEmptyThrow(${firstLowDomainName}Dto, "A00004");
Map
<String,Object> res = Maps.newHashMap();
List
<SortDto> sortDtoList = ListTs.newArrayList();
    List
    <SortDto> ${firstLowDomainName}DtoSortDtoList = ${firstLowDomainName}Dto.getSortDtoList();
        ...
        // TODO 查询条件待定
        List
        <Predicate> predicates = Lists.newArrayList();
            ...
            Page
            <${domainName}Dto> byPage = this.findByPage(${firstLowDomainName}Dto, specification, ${domainName}Dto.class,
                sortDtoList.toArray(new SortDto[]{}));
                ...
                @Transactional
                public List
                <${domainName}Dto> save${domainName}(List
                    <${domainName}Dto> ${firstLowDomainName}Dtos) {
                        isEmptyThrow(${firstLowDomainName}Dtos, "A00004");
                        List
                        <${domainName}Dto> res = new ArrayList<>();
                            ...
                            ${domainName}Dto ${firstLowDomainName}Dto1 = this.baseSaveReturnDto(${domainName}
                            , ${firstLowDomainName}Dto);
                            ...
                            @Transactional
                            public List
                            <${domainName}Dto> update${domainName}(List
                                <${domainName}Dto> ${firstLowDomainName}Dtos) {
                                    isEmptyThrow(${firstLowDomainName}Dtos, "A00004");
                                    for (${domainName}Dto ${firstLowDomainName}Dto : ${firstLowDomainName}Dtos) {
                                    String dtoId = getDtoId(${firstLowDomainName}Dto);
                                    int version = getDtoVersion(${firstLowDomainName}Dto);
                                    ${domainName} ${firstLowDomainName} = this.updateById(${firstLowDomainName}Dto,
                                    dtoId, version);
                                    ...
                                    @Transactional
                                    public List
                                    <String> delete${domainName}(List
                                        <${domainName}Dto> ${firstLowDomainName}Dtos) {
                                            isEmptyThrow(${firstLowDomainName}Dtos, "A00004");
                                            List
                                            <String> collect = ${firstLowDomainName}
                                                Dtos.stream().map(this::getDtoId).distinct().collect(Collectors.toList());
                                                ...
                                                @Transactional
                                                public List
                                                <String> enableOrDisabled${domainName}(List
                                                    <${domainName}Dto> ${firstLowDomainName}Dtos) {
                                                        isEmptyThrow(${firstLowDomainName}Dtos, "A00004");
                                                        List
                                                        <String> collect = ${firstLowDomainName}
                                                            ...
                                                            @Override
                                                            public List
                                                            <${domainName}Dto> get${domainName}ByIds(List
                                                                <String> ${firstLowDomainName}Ids) {
                                                                    List<${domainName}> allById =
                                                                    this.daoRepository.findAllById(${firstLowDomainName}
                                                                    Ids);
                                                                    if (CollUtil.isNotEmpty(allById)) {
                                                                    List
                                                                    <${domainName}Dto> ${firstLowDomainName}Dtos = new
                                                                        ArrayList<>();
                                                                        for (${domainName} ${firstLowDomainName} :
                                                                        allById) {
                                                                        ${domainName}Dto ${firstLowDomainName}Dto =
                                                                        new ${domainName}Dto();
                                                                        BeanUtil.copyProperties(${firstLowDomainName}
                                                                        ,${firstLowDomainName}Dto);
                                                                        ${firstLowDomainName}
                                                                        Dtos.add(${firstLowDomainName}Dto);
                                                                        }
                                                                        return ${firstLowDomainName}Dtos;
                                                                        }
                                                                        return null;
