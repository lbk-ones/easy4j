 ...
 * @author zhaoyuguang
 */
public abstract class FlowDegradeAspectSupport {

    protected void traceException(Throwable ex) {
        Tracer.trace(ex);
    }

    protected void traceException(Throwable ex, FlowDegradeResource annotation) {
    ...
    protected Object handleFallback(ProceedingJoinPoint pjp, FlowDegradeResource annotation, Throwable ex)
        throws Throwable {
    ...
    protected Object handleBlockException(ProceedingJoinPoint pjp, FlowDegradeResource annotation, BlockException ex)
        throws Throwable {
    ...
    private Method extractDefaultFallbackMethod(ProceedingJoinPoint pjp, String defaultFallback,
        ...
        if (StringUtil.isBlank(defaultFallback)) {
            FlowDegradeResource annotationClass = pjp.getTarget().getClass().getAnnotation(FlowDegradeResource.class);
