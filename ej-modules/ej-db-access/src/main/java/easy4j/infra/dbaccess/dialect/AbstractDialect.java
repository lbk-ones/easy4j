...
import easy4j.infra.dbaccess.dll.op.DBFieldEscapeChecker;
...
public abstract class AbstractDialect implements Dialect {
    ...
    public AbstractDialect(Connection connection) {
    ...
    public String escape(String name) {
        ...
        lbk:
        {
            ...
            }else if (DbType.DB2.getDb().equals(databaseType) && !containLower(name)) {
                if (!ListTs.equalIgnoreCase(DB2_ESCAPE, name)) {
                    return name;
                }
            }
        }
