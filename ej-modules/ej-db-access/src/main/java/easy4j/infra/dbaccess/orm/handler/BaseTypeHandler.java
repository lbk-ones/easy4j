...
public abstract class BaseTypeHandler<T> extends TypeReference<T> implements TypeHandler<T> {
  ...
  public void setParameter(PreparedStatement ps, int i, T parameter, JdbcType jdbcType) throws SQLException {
    if (parameter == null) {
      ...
      try {
        ...
        throw new AccessException("Error setting non null for parameter #" + i + " with JdbcType " + jdbcType + " . "
  ...
  public T getResult(ResultSet rs, String columnName) throws SQLException {
    try {
      ...
      throw new AccessException("Error attempting to get column '" + columnName + "' from result set.  Cause: " + e,
          e);
    }
  }
  ...
  public T getResult(ResultSet rs, int columnIndex) throws SQLException {
    try {
      ...
      throw new AccessException("Error attempting to get column #" + columnIndex + " from result set.  Cause: " + e,
          e);
    }
  }
